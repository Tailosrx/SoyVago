                ...
                <form method="GET" class="filtro-form">
                    <div class="filtro-grupo">
                        ...
                        <select name="completado" id="completado">
                            <option value="todas" <?= $filtro_completado === 'todas' ? 'selected' : '' ?>>Todas las metas
                            </option>
                            <option value="completadas" <?= $filtro_completado === 'completadas' ? 'selected' : '' ?>>Solo
                                completadas</option>
                            <option value="pendientes" <?= $filtro_completado === 'pendientes' ? 'selected' : '' ?>>Solo
                                pendientes</option>
                        </select>
                    </div>
                    ...
                    <div class="filtro-grupo">
                        ...
                        <select name="orden" id="orden">
                            <option value="fecha_creacion_desc" <?= $orden === 'fecha_creacion_desc' ? 'selected' : '' ?>>
                                Más recientes primero</option>
                            <option value="fecha_creacion_asc" <?= $orden === 'fecha_creacion_asc' ? 'selected' : '' ?>>Más
                                antiguas primero</option>
                            <option value="fecha_limite_asc" <?= $orden === 'fecha_limite_asc' ? 'selected' : '' ?>>Fecha
                                límite (próximas)</option>
                            <option value="importancia_desc" <?= $orden === 'importancia_desc' ? 'selected' : '' ?>>Más
                                importantes primero</option>
                        </select>
                    </div>
                            ...
                            <div class="streak-card-extended <?= $meta['completado'] ? 'completada' : '' ?>"
                                ...
                                <div class="fecha-container">
                                    <?php if ($meta['fecha_limite']): ?>
                                        ...
                                        ?>
                                    <?php else: ?>
                                        <p class="fecha-limite">⏳ No hay Tiempo tranki</p>
                                    <?php endif; ?>
                                </div>
