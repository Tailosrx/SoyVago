    ...
    <li class="sidebar__item"> 
        <a class="sidebar__link" href="#" data-tooltip="Calendario"> 
            ...
            <ul class="sidebar__list list--secondary">
                ...
                <li class="sidebar__item"> <a class="sidebar__link" href="ajustes.php" data-tooltip="Settings"> <span class="icon"> <svg width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
